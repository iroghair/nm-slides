\begin{tikzpicture}
    ...
    \draw [scharlaken, thick] plot[smooth, tension=1] coordinates {(A) (B) (C) (D) (E) (F) (G)};
    
    % Draw points for reference
    \draw[tuesteel, dashed] (B) node[circle, fill=tuesteel, inner sep=1pt] {} -- (Bx)   node[at end, above] {$a$};
    \draw[tuesteel, dashed] (F) node[circle, fill=tuesteel, inner sep=1pt] {} -- (Fx)   node[at end, below] {$b$};
