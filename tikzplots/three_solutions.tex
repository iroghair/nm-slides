\begin{tikzpicture}
    ...
    \draw [scharlaken, thick] plot[smooth, tension=1] coordinates {(A) (B) (C) (D) (E) (F) (G) (H) (I)};
    
    % Draw points for reference
    \draw[tuesteel, dashed] (B) node[circle, fill=tuesteel, inner sep=1pt] {} -- (Bx)   node[at end, above] {$a$};
    \draw[tuesteel, dashed] (I) node[circle, fill=tuesteel, inner sep=1pt] {} -- (Ix)   node[at end, below] {$b$};
