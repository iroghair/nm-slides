\begin{tikzpicture}
    \begin{axis}[
      ...
      ylabel={\(y\)},
      grid=both,
      grid style={line width=.1pt, draw=tuesteel!20},
      major grid style={line width=.2pt,draw=tuesteel!50},
    ...
    \draw[fill=red, draw=tuesteel] (r0) circle (0.01\textwidth);
    \draw[fill=red, draw=tuesteel] (r1) circle (0.01\textwidth);
