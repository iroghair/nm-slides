...
\centering\includegraphics[width=0.7\textwidth]{matlab.png}
\end{frame}
...
\centering\includegraphics[width=0.7\textwidth]{cftool.png}
\end{frame}
...
\begin{frame}[fragile]
 ...
 \begin{frame}[fragile]
  ...
  \begin{enumerate}
    ...
    \vskip1em
    \item Make a plot of the functions: $f(x)=sin(1/x)$ and $f(x)=cos(1/x)$ over the interval $[0.01,0.1]$. How do you create \lstinline$x$ so that the plots look sufficiently smooth?
  \end{enumerate}
 \end{frame}
