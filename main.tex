...
% Handout mode
\documentclass[10pt,table,final,fleqn,hyperref={pdfpagemode=UseThumbs, pdfpagelayout=SinglePage,bookmarks=true,},xcolor={usenames,dvipsnames},aspectratio=169,handout]{beamer}

% Presentation mode
% \documentclass[10pt,table,final,fleqn,hyperref={pdfpagemode=FullScreen},xcolor={usenames,dvipsnames},aspectratio=169]{beamer}
...
\lecture{Non-linear Equations 1}{nonlin1}
\include{sections/nonlin1}

\title{Non-linear equations}
\subtitle{Towards the multi-dimensional case}
\lecture{Non-linear Equations 2}{nonlin2}
\include{sections/nonlin2}

\title{Sample slides}
\subtitle{Examples and code testing}
\lecture{Samples}{sample}
