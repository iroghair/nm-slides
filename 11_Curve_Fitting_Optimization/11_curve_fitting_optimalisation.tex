...
%     emph=[1]{for,end,break},emphstyle=[1]\color{red}, %some words to emphasise
    emph=[2]{int,simplify,diff,log,atan,syms,interp3,interpn,ones,linprog,cftool,optimset,lsqnonlin}, emphstyle=[2]{\color{blue}}
}
...
\begin{frame}[fragile] 
  ...
  \pause
  \begin{itemize}
    \item First, we create a fit criterium function:
    \begin{lstlisting}
...
err = (ue-U);
    \end{lstlisting}
    \pause
    \item We need to create a function that solves our ode. Here, we use the internal \lstinline$ode45$ solver:
    \begin{lstlisting}
...
\begin{frame}[fragile] 
  \frametitle{Example use of lsqnonlin}
  \input{tikzplots/lsqnonlinfit.tikz}
\end{frame}
