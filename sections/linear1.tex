...
\frametitle{Computing the co-factors}
  ...
  $ M =
    ...
    \end{bmatrix} 
  $\\ \vskip1em \pause
  A co-factor (e.g. $C_{11}$) is the \tikzmarkin[txt=style tueturq]{det1}determinant of the elements left over\tikzmarkend{det1} when you cover up the row and column of the \tikzmarkin[txt=style tuesteel]{cof}element in question\tikzmarkend{cof}, \tikzmarkin[txt=style tueorange]{pm1}multiplied by $\pm 1$\tikzmarkend{pm1}, depending on the position. \vskip1em
  \begin{columns}
    \column{0.25\textwidth}
      \begin{equation*}
      \left[\begin{array}{ccc}
	\tikzmarkin[mat=style tuesteel]{col 1} 1 \tikzmarkend{col 1} &  \times & \times \\
	\times  & \tikzmarkin[mat=style tueturq]{col 2} 1 & 3 \\
    ...
    \column{0.25\textwidth}
      \begin{equation*}
      \left[\begin{array}{ccc}
	\tikzmarkin[mat2=style tueorange]{pm} + \tikzmarkend{pm} &  - & + \\
	- & + & - \\
	+ & - & +\\
	\end{array}\right]
      \end{equation*}\pause
      \column{0.5\textwidth}
      \[ \begin{split}
C_{11} &= \tikzmarkin[mat2=style tueorange]{pm3}+1\tikzmarkend{pm3}\ \cdot\ \det{\begin{array}{cc}\tikzmarkin[mat=style tueturq]{det2} 1 & 3 \\ 1 & 6\tikzmarkend{det2}\end{array}} \\
&= 6 \times 1 - 3 \times 1 = 3
\end{split}
\]
  \end{columns}
...
\frame{\frametitle{Calculating the determinant}
    ...
    \[
    \det{\begin{bmatrix}
      \ \tikzmarkin[mat=style tueturq]{horizontal}1 & 1 & 1 \tikzmarkend{horizontal}\\
      2 & 1 & 3 \\
    ...
    \[
    \det{\begin{bmatrix}
      \ 1 & 1 & \tikzmarkin[mat=style tueturq]{vertical}1 \\
      2 & 1 & 3 \\
...
%   \]\vspace{-1em}
%   \begin{itemize}
%     \item Create matrix \ \tikzmarkin[mat=style tueturq]{A}$A$\tikzmarkend{A} \ in $3\times 3$ cells
%     \item Create right hand side vector \ \tikzmarkin[mat=style tuesteel]{b}$b$\tikzmarkend{b} \ in 3 vertical cells\pause
%     \item Compute the inverse \ \tikzmarkin[mat=style tueorange]{I}$I$\tikzmarkend{I} \ :
%     \begin{itemize}
%       \item Select an empty area of $3 \times 3$ cells
%       \item Type \lstinline$=MINVERSE($
%       \tikzmarkin[txt=style tueturq]{A2}\lstinline$B2:D4$\tikzmarkend{A2}
...
%       \tikzmarkin[txt=style tueorange]{I2}\lstinline$H2:J4$\tikzmarkend{I2}
%       % Semicolon
%       \lstinline$;$
%       % Second part, contains the RHS
%       \tikzmarkin[txt=style tuesteel]{b2}\lstinline$B6:B8$\tikzmarkend{b2}
%       % Finish the command
