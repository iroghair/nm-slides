...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \begin{lstlisting}
import numpy as np
import numpy.linalg as la # scipy.linalg also works!
    \end{lstlisting}
...
b = np.array([[4.,7.,5.]]).T # Check b.shape!
    \end{lstlisting}\pause
    \item Get the matrix inverse; we use the linalg sub:
    \begin{lstlisting}
Ainv = linalg.inv(A)
    \end{lstlisting}\pause
...
print(f'The solution is:\n {solution}')
      \end{lstlisting}      
      &
        \begin{lstlisting}[style=output,linewidth=0.5\textwidth]
The solution is:
[[13.]
[-4.]
[-5.]]
