...
%   \footnotesize\selectfont
  ...
  \begin{multline*}
    f(x_i+h,y_i+k) = f_i + h \left. \frac{\partial f}{\partial x}\right|_i + h\left. \frac{\partial f}{\partial y}\right|_i + \mathcal{O}{(h^2)} \\
...
>> ode45(myEqn, [0 40], 0);
  ...
  \centering\begin{tikzpicture}
    \begin{axis}[%every axis/.append style={font=\footnotesize},
      ...
      \addplot[graph,mark=x] table []{ODE_matlabsolve_single.dat};  
      \addlegendentry{$x_1$}
    %  \addlegendentry{$x_2$}
    \end{axis}
  \end{tikzpicture}
  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[%every axis/.append style={font=\footnotesize},
        ...
        \addplot[graph,mark=x] table []{ODE_matlabsolve_single2.dat};  
        \addlegendentry{$x_1$}
      %  \addlegendentry{$x_2$}
      \end{axis}
    \end{tikzpicture}
...
\begin{center}
  \begin{tikzpicture}
    \begin{axis}[%every axis/.append style={font=\footnotesize},
      ...
      \addplot[graph,mark=x] table []{ODE_matlabsolve_implicit11.dat};  \addlegendentry{$x_1$}
      \addplot[graph,mark=o,draw=tueblue,mark options={fill=white}] table []{ODE_matlabsolve_implicit12.dat};  \addlegendentry{$x_2$}
    \end{axis}
  \end{tikzpicture}
  \begin{tikzpicture}
    \begin{axis}[%every axis/.append style={font=\footnotesize},
      ...
      \addplot[graph,mark=x] table []{ODE_matlabsolve_implicit21.dat};  \addlegendentry{$x_1$}
      \addplot[graph,mark=o,draw=tueblue,mark options={fill=white}] table []{ODE_matlabsolve_implicit22.dat};  \addlegendentry{$x_2$}
    \end{axis}
  \end{tikzpicture}
\end{center}
