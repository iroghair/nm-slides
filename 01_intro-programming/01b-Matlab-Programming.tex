...
\begin{frame}
  ...
  \pause
    \begin{enumerate}
      ...
      \item Start the solver, and minimize the sum by changing cells for $A$, $B$ and $C$.
    \end{enumerate}
  \end{columns}
\end{frame}
...
\begin{frame}
 ...
 \end{itemize}\pause
	...
	\node[xshift=0cm,yshift=0cm, anchor=center] at (current page.center) {\includegraphics[width=\textwidth]{img/fullnerd2.png}};}
      \end{tikzpicture}}
\end{frame}
